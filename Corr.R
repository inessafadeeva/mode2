## Фадеева Инесса -  для ночных данных за осень 2019 года, постройте регрессионную зависимость
## скорости сокотечения (переменная Flux) для деревьев старше IV и высокой антропогенной нагрузкой
